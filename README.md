...
1. Google Cloud Link: [ecosort]()
2. Vercel Link: [ecosort](https://eco-sort-hackathon.vercel.app/)
...
- **🛡️ Admin Panel**: Comprehensive backend for managing users, verifying submissions, and tracking revenue.
- **🤝 Partner Portal**: Dedicated interface for service providers to manage leads and buy carbon credits.
...
2. **Auth**: Mock login interface supporting Users, Admins, and Providers.
3. **Report Waste**: Select category -> Answer questions -> Get Recommendation.
4. **Dashboard**: View personal and campus-wide statistics.
5. **Partner Portal**: Providers log in to manage business leads and sponsorships.
